...
form { display: grid; gap: 18px; margin-top: 25px; }label span { display: block; margin-bottom: 7px; color: #9db2bc; font-size: 12px; }input { box-sizing: border-box; width: 100%; height: 42px; border: 1px solid #294858; border-radius: 0; padding: 0 12px; outline: none; color: #e9f4f6; background: #091722; font-size: 13px; }input:focus { border-color: #24d4c4; }
