...
.login-error { margin: -7px 0 -4px; color: #ff8181; font-size: 11px; }.login-panel footer { margin-top: 24px; padding-top: 16px; border-top: 1px solid #1d3948; display: flex; flex-wrap: wrap; gap: 7px 12px; color: #607d8b; font-size: 10px; }.login-panel footer span { width: 100%; color: #8da7b5; }.login-panel code { color: #6f9cab; font-family: Consolas, monospace; }
