...
.brand-symbol { width: 54px; height: 54px; display: grid; grid-template-columns: repeat(3, 1fr); gap: 5px; align-items: end; padding: 10px; border: 1px solid #317283; border-radius: 4px; }
...
.login-brand > p { margin: 38px 0 12px; color: #5f8291; font-size: 12px; letter-spacing: 2px; }.login-brand h1 { max-width: 700px; margin: 0; color: #edf8fa; font-size: clamp(34px, 3vw, 56px); line-height: 1.25; letter-spacing: 0; }
...
.login-panel { width: min(390px, calc(100% - 64px)); align-self: center; justify-self: center; border-top: 2px solid #24d4c4; border-radius: 4px; background: #0c1b28; box-shadow: 0 28px 80px rgba(0,0,0,.32); padding: 32px; }
.login-panel header { display: flex; align-items: center; gap: 13px; padding-bottom: 24px; border-bottom: 1px solid #1d3948; }.login-panel header img { width: 25px; height: 25px; filter: invert(76%) sepia(60%) saturate(465%) hue-rotate(126deg); }.login-panel h2 { margin: 0; font-size: 21px; letter-spacing: 0; }.login-panel header p { margin: 5px 0 0; color: #708d9b; font-size: 12px; }
form { display: grid; gap: 18px; margin-top: 25px; }label span { display: block; margin-bottom: 7px; color: #9db2bc; font-size: 12px; }input { box-sizing: border-box; width: 100%; height: 40px; border: 1px solid #294858; border-radius: 4px; padding: 0 12px; outline: none; color: #e9f4f6; background: #091722; font-size: 13px; }input:focus { border-color: #24d4c4; }
form button { height: 44px; margin: 3px 0 0; border: 0; border-radius: 4px; display: flex; align-items: center; justify-content: center; gap: 8px; color: #06141d; background: #24d4c4; font-weight: 700; cursor: pointer; }form button:disabled { cursor: not-allowed; opacity: .45; }form button img { width: 17px; height: 17px; }
.login-error { margin: -7px 0 -4px; color: #ff8181; font-size: 12px; }.login-panel footer { margin-top: 24px; padding-top: 16px; border-top: 1px solid #1d3948; display: flex; flex-wrap: wrap; gap: 7px 12px; color: #607d8b; font-size: 12px; }.login-panel footer span { width: 100%; color: #8da7b5; }.login-panel code { color: #6f9cab; font-family: Consolas, monospace; }
