...
.dashboard-shell.has-data-error { grid-template-rows: 56px 30px 100px minmax(0, 1fr) 208px; }
...
.data-stale,.data-unknown { height: 32px; padding: 0 8px; display: flex; align-items: center; font-size: 12px; white-space: nowrap; }.data-stale { border: 1px solid #8d6230; color: #f3b33d; background: #241d18; }.data-unknown { border: 1px solid #456879; color: #9fc4d2; background: #10212c; }
.principal-badge { min-width: 118px; height: 32px; display: flex; flex-direction: column; justify-content: center; padding: 0 9px; border-left: 2px solid #24d4c4; background: #0b1b28; }.principal-badge small { color: #24d4c4; font-size: 12px; }.principal-badge strong { color: #dcecef; font-size: 12px; font-weight: 600; white-space: nowrap; }
...
.map-legend { display: flex; gap: 12px; }.map-legend span { color: #829ba8; font-size: 12px; }.dot { display: inline-block; width: 6px; height: 6px; margin-right: 4px; }.dot.located { background: #ffd166; box-shadow: 0 0 7px #ffd166; }.dot.missing { border: 1px solid #f26464; }
...
.risk-level { width: 40px; padding: 2px 0; text-align: center; font-size: 12px; white-space: nowrap; border: 1px solid #c38a30; color: #f3b33d; }.risk-critical .risk-level { border-color: #b94b53; color: #ff7b7b; }.risk-notice .risk-level { border-color: #3a7189; color: #62bde3; }
...
.data-error-strip { min-width: 0; height: 30px; padding: 0 12px; display: grid; grid-template-columns: auto minmax(0, 1fr) auto; align-items: center; gap: 10px; overflow: hidden; border: 1px solid #7f454d; border-left: 3px solid #f26464; color: #efc7ca; background: #281a23; font-size: 12px; }
...
.page-state,.empty-business { position: fixed; inset: 0; z-index: 28; display: grid; place-items: center; color: #9fbbc5; background: rgba(7,17,28,.88); font-size: 13px; }.page-state-error { color: #ff9b9b; }.empty-business { inset: 166px 12px 10px; z-index: 5; background: rgba(7,17,28,.72); pointer-events: none; }
...
.control-grid { height: calc(100% - 54px); display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); grid-template-rows: repeat(3, minmax(0, 1fr)); }.control-grid > view { min-width: 0; min-height: 0; overflow: hidden; display: flex; flex-direction: column; justify-content: center; padding: 8px 16px; border-right: 1px solid #17303f; border-bottom: 1px solid #17303f; }.control-grid small { color: #74909d; font-size: 12px; }.control-grid strong { margin: 3px 0 2px; color: #f3b33d; font: 600 22px var(--font-numeric); }.control-grid span { color: #526f7c; font-size: 12px; }.settlement-metrics { height: calc(100% - 94px); display: grid; grid-template-columns: repeat(2, 1fr); }.settlement-metrics > view { display: flex; flex-direction: column; justify-content: center; padding: 16px; border-right: 1px solid #17303f; }.settlement-metrics small { color: #74909d; font-size: 12px; }.settlement-metrics strong { margin-top: 8px; color: #24d4c4; font: 600 22px var(--font-numeric); }.settlement-note { height: 40px; padding: 0 16px; border-top: 1px solid #17303f; color: #6e8996; font-size: 12px; line-height: 40px; }
...
.modal-mask { position: fixed; inset: 0; z-index: 40; display: grid; place-items: center; background: rgba(2, 8, 13, .78); }.definition-dialog { width: min(620px, 80vw); max-height: 76vh; display: flex; flex-direction: column; overflow: hidden; border: 1px solid #356579; background: #0b1b28; box-shadow: 0 18px 70px rgba(0,0,0,.45); }.definition-dialog header { height: 64px; flex: none; padding: 0 18px; display: flex; align-items: center; justify-content: space-between; border-bottom: 1px solid #234353; }.definition-dialog h2 { margin: 0; font-size: 17px; }.definition-dialog p { margin: 5px 0 0; color: #7893a2; font-size: 12px; }.definition-dialog button { width: 32px; height: 32px; margin: 0; padding: 0; border-radius: 0; border: 1px solid #325467; color: #bdd0d7; background: transparent; line-height: 30px; cursor: pointer; }.definition-dialog dl { min-height: 0; margin: 0; padding: 8px 18px 18px; overflow-y: auto; }.definition-dialog dt { margin-top: 12px; color: #24d4c4; font-size: 12px; }.definition-dialog dd { margin: 5px 0 0; color: #9fb5bf; font-size: 12px; line-height: 1.7; }
.drawer-mask { position: fixed; inset: 0; z-index: 42; background: rgba(2,8,13,.72); }.risk-drawer { position: absolute; top: 0; right: 0; width: min(520px, 90vw); height: 100%; display: flex; flex-direction: column; overflow: hidden; outline: 0; border-left: 1px solid #356579; background: #0b1b28; box-shadow: -18px 0 70px rgba(0,0,0,.45); }.risk-drawer > header { min-height: 116px; flex: none; padding: 22px 24px; display: flex; justify-content: space-between; gap: 18px; border-bottom: 1px solid #234353; }.risk-drawer header small { color: #5f8291; font-size: 12px; }.risk-drawer h2 { margin: 6px 0; font-size: 20px; }.risk-drawer header p { margin: 0; color: #8ba3ad; font-size: 12px; line-height: 1.6; }.risk-drawer header button { width: 32px; height: 32px; flex: 0 0 32px; border: 1px solid #325467; border-radius: 0; color: #bdd0d7; background: transparent; cursor: pointer; }.risk-drawer-summary { height: 74px; flex: none; display: flex; align-items: baseline; gap: 10px; padding: 18px 24px; border-bottom: 1px solid #193647; }.risk-drawer-summary span { padding: 3px 7px; border: 1px solid #ad7f36; color: #f3b33d; font-size: 12px; }.risk-drawer-summary span.level-critical { border-color: #a9474f; color: #ff7777; }.risk-drawer-summary strong { color: #f26464; font: 600 28px var(--font-numeric); }.risk-drawer-summary small { color: #718d99; }.risk-subject-list { flex: 1; min-height: 0; overflow: auto; padding: 8px 24px 24px; }.risk-subject-list article { padding: 15px 0; border-bottom: 1px solid #193647; }.risk-subject-list article > view { display: flex; justify-content: space-between; gap: 12px; }.risk-subject-list strong { color: #d8e8ec; font-size: 12px; }.risk-subject-list span,.risk-subject-list small { color: #5f7f8d; font-size: 12px; }.risk-subject-list p { margin: 8px 0; color: #8fa7b1; font-size: 12px; line-height: 1.6; }.farm-drawer-body { flex: 1; min-height: 0; overflow-y: auto; }
@media (max-height: 820px) {
  .dashboard-shell { grid-template-rows: 50px 88px minmax(0, 1fr) 174px; gap: 7px; padding: 7px 9px; }
  .dashboard-shell.has-data-error { grid-template-rows: 50px 28px 88px minmax(0, 1fr) 174px; }
...
.data-status { height: 32px; padding: 0 8px; display: flex; align-items: center; border: 1px solid #3d6577; color: #c6dce3; background: #10212c; font-size: 12px; white-space: nowrap; }
...
@media (max-height: 700px) {
  ...
  .dashboard-shell.has-data-error { grid-template-rows: 50px 26px 88px minmax(0, 1fr) 168px; }
