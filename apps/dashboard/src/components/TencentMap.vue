...
.map-state strong { color: #ff9b9b; font-weight: 500; }.map-state button { height: 30px; padding: 0 14px; border: 1px solid #2f7f7a; border-radius: 4px; color: #8ce6dd; background: #0b292b; cursor: pointer; }
...
:deep(.point-glyph) { width: 100%; height: 100%; display: grid; place-items: center; border: 2px solid rgba(236, 252, 252, .9); border-radius: 50%; background: #26d1c1; box-shadow: 0 0 0 2px rgba(38, 209, 193, .16), 0 4px 14px rgba(0, 0, 0, .48); font: 700 13px/1 "Microsoft YaHei", sans-serif; }
:deep(.point-city) { width: 34px; height: 34px; }.point-city :deep(.point-glyph) { background: #22cfbb; }.point-city.tone-risk :deep(.point-glyph) { border-color: #ffd17a; background: #f2b84b; box-shadow: 0 0 0 2px rgba(242, 184, 75, .2), 0 4px 14px rgba(0, 0, 0, .48); }
