import { applyPlatformEntities, applyPlatformMedia, cloneSeed, farms, liveRooms, mergePlatformLives, mockDelay, products } from '@agritainment/shared'
...
export const userRepository = {
  loadDashboard: (scenario: MockScenario = 'normal') => {
    ...
    const packageProducts = seedAll.filter((item) => item.category === '套餐券')
