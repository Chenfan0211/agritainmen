  ...
  <view class="app-shell" :class="{ 'has-cart-bar': store.cart.length && activeTab !== 'cart' }">
    ...
    <template v-else>
      ...
      <view v-else class="page-content me-page" data-visual-view="user-me">
        ...
        <view v-if="store.currentDistributor" class="operations-grid"><view @click="openOperations('income')"><view class="operation-icon coral"><UiIcon name="badge-dollar-sign" :size="22" /></view><text>我的收入</text></view><view @click="openOperations('fans')"><view class="operation-icon blue"><UiIcon name="user-round-check" :size="22" /></view><text>我的粉丝</text></view><view @click="openOperations('orders')"><view class="operation-icon green"><UiIcon name="package-check" :size="22" /></view><text>团队订单</text></view><view @click="openOperations('performance')"><view class="operation-icon gold"><UiIcon name="chart-no-axes-combined" :size="22" /></view><text>团队业绩</text></view></view>
