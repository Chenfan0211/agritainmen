...
const persistedKeys = ['tenant', 'farm', 'member', 'role', 'products', 'selectableProducts', 'cart', 'bookings', 'orders', 'rooms', 'shares', 'balanceEntries', 'promotionRecords', 'foods', 'auth'] as const
