...
describe('supplier store interactions', () => {
  ...
  it('provides warehouse and store coordinates plus navigation URLs', () => {
    ...
    expect(buildNavigationUrl('石板溪农家乐·门店', store)).toContain('https://uri.amap.com/navigation?to=')
    expect(buildNavigationUrl('未知门店', { address: '湖南省湘西州测试路', contact: '', phone: '' })).toBe('https://uri.amap.com/search?keyword=%E6%B9%96%E5%8D%97%E7%9C%81%E6%B9%98%E8%A5%BF%E5%B7%9E%E6%B5%8B%E8%AF%95%E8%B7%AF')
